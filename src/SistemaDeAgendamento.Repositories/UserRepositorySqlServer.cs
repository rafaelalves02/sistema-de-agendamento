...
{
    public class UserRepositorySqlServer : BaseRepository, IUserRepository
    {
        public UserRepositorySqlServer(string connectionString) : base(connectionString)
        {
        }
        ...
        public int? Insert(User user)
        {
            ...
            using (var conn = new SqlConnection(ConnectionString))
            {
                string query = @"INSERT INTO [user] (username, password, role_id) 
