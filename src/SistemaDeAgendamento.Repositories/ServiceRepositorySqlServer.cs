...
{
    public class ServiceRepositorySqlServer : BaseRepository, IServiceRepository
    {
        public ServiceRepositorySqlServer(string connectionString) : base(connectionString)
        {
        }
