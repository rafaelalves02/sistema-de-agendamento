...
{
    public class EmployeeRepositorySqlServer : BaseRepository, IEmployeeRepository
    {
        public EmployeeRepositorySqlServer(string connectionString) : base(connectionString)
        {
        }
        ...
        public int? Insert(Employee employee)
        {
            ...
            {
                var query = @"INSERT INTO employee (name, email, phone_number, user_id) 
        ...
        public IList<Employee> Read()
        {
            ...
            using (var conn = new SqlConnection(ConnectionString))
            {
                var query = @"SELECT e.employee_id, e.name, e.phone_number, e.email, u.user_id, u.password, u.username 
                              FROM employee e 
        ...
        public Employee? GetById(int id)
        {
            ...
            using (var conn = new SqlConnection(ConnectionString))
            {
                var query = @"SELECT e.employee_id, e.name, e.phone_number, e.email, u.user_id, u.username, u.password 
                              FROM employee e 
                              INNER JOIN [user] u ON e.user_id = u.user_id 
