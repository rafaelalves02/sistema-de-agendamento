...
{
    public class AvailabilityRepositorySqlServer : BaseRepository, IAvailabilityRepository
    {
        public AvailabilityRepositorySqlServer(string connectionString) : base(connectionString)
        {
        }
